...
In this workshop, we will touch upon a few levels of Terraform. The ultimate goal is to deploy a Linux virtual machine in an existing Azure VNet.

> Assignments are marked like this.
> 
And you can also earn **Bonus points**! These are not included in the solution, so it's fully up to you on how you solve these challenges!
